...
public class MagicBoltEntityRenderer extends EntityRenderer<MagicBoltEntity> {
    private static final Identifier TEXTURE = new Identifier("trexsmod:textures/entity/magic_bolt.png");
    ...
    @Override
    protected int getBlockLight(MagicBoltEntity magic_Bolt_Entity, BlockPos blockPos) {
        return 15;
    }

    @Override
    public void render(MagicBoltEntity magic_Bolt_Entity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
        ...
        matrixStack.pop();
        super.render(magic_Bolt_Entity, f, g, matrixStack, vertexConsumerProvider, i);
    }
    ...
    @Override
    public Identifier getTexture(MagicBoltEntity magic_Bolt_Entity) {
        return TEXTURE;
    }
