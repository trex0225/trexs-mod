...
public class MagicMissileEntity extends ThrownEntity implements Vanishable {
    ...
    public MagicMissileEntity(EntityType<? extends MagicMissileEntity> entityType, double d, double e, double f, World world) {
        super(entityType, d, e, f, world);
    }

    public MagicMissileEntity(LivingEntity livingEntity, World world, int addition) {
        super(EntityInit.MAGIC_MISSILE_ENTITY, livingEntity, world);
        this.add = addition;
    }

    @Environment(EnvType.CLIENT)
    public MagicMissileEntity(World world, double x, double y, double z, double directionX, double directionY, double directionZ) {
        super(EntityInit.MAGIC_MISSILE_ENTITY, x, y, z, world);
    }
